...
function publish_release {
   ...
   # We must publish to releases.hashicorp.com first above so that any
   # Docker automated builds from pushing the tag can retrieve the proper
   # version.
   if is_set "${pub_git}"
   then
